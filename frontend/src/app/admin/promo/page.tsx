            ...
            >
              ...
              <div className="flex flex-col items-center text-center">
                <div className="w-24 h-24 bg-boston-gold/10 rounded-full border-2 border-boston-gold/30 flex items-center justify-center mb-6 shadow-[0_0_40px_rgba(212,175,55,0.1)] overflow-hidden">
                   {scannedUser.avatarId && scannedUser.avatarId !== 'default' ? (
                     <img 
                       src={
                         scannedUser.avatarId.startsWith('http') ? scannedUser.avatarId : 
                         scannedUser.avatarId.match(/^A[1-6]$/) ? `/avatars/${scannedUser.avatarId}.png` : 
                         `https://mybostonclub.com${scannedUser.avatarId}`
                       } 
                       alt="Avatar" 
