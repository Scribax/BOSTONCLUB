    ...
    <div className="min-h-screen bg-boston-black flex flex-col md:flex-row">
      ...
      <nav className="fixed md:sticky bottom-0 md:top-0 w-full md:w-72 bg-[#0c0c0c] md:h-screen border-t md:border-t-0 md:border-r border-white/10 z-50 flex md:flex-col justify-around md:justify-start p-2 md:p-8 pb-6 md:pb-8 shadow-xl shadow-black">
        ...
        <Link href="/admin/settings/puntos" className="flex flex-col md:flex-row items-center gap-2 md:gap-4 p-3 md:px-4 md:py-3 rounded-xl hover:bg-white/5 transition-colors text-white/70 hover:text-white">
           <Coins className="w-5 h-5 text-boston-gold" />
           <span className="text-[10px] md:text-sm font-bold uppercase tracking-wider">Config. Puntos</span>
        </Link>

        <Link href="/admin/settings/mercadopago" className="flex flex-col md:flex-row items-center gap-2 md:gap-4 p-3 md:px-4 md:py-3 rounded-xl hover:bg-white/5 transition-colors text-white/70 hover:text-white">
           <CreditCard className="w-5 h-5 text-boston-gold" />
           <span className="text-[10px] md:text-sm font-bold uppercase tracking-wider">MercadoPago</span>
        </Link>
